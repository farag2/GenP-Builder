...
# https://wiki.dbzer0.com/genp-guides/guide#download-directory
$Parameters = @{
	Uri             = "https://salmon-managing-unicorn-252.mypinata.cloud/ipfs/bafybeie64fdq7lkx2unqlwgs5t5gcba57awciiy3om73v2ypk4anedcubu?filename=GenP_4.0.3_SOURCE.zip&download=true"
